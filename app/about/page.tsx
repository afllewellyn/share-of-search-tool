...
{`  searches for your brand this month
  ...
  searches for all the brands in your set`}
          ...
          <Section eyebrow="05 / WHERE THE NUMBERS COME FROM" title="One question to Google, one report back">
            <p>
              When you run a report, the site pulls the monthly search counts for the brand and keywords you entered, does the maths, and hands the finished report back to your browser. The counts come from Google&apos;s Keyword Planner via DataForSEO API to show you how many times people searched each term on Google that month. Nothing you type is saved anywhere. Close the tab and it is gone, unless you downloaded the file.
            </p>
            <p>
