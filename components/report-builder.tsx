...
export default function ReportBuilder() {
  ...
  async function submit(event: React.FormEvent) {
    ...
    try {
      ...
      setReport(data as Report); window.scrollTo({ top: 0, behavior: 'smooth' })
