...
type Row = { brand: string; is_own_brand: boolean; sos_pct: number | null; raw_volume: number | null; mom_delta_pp: number | null; yoy_delta_pp: number | null; rank: number | null; rank_change: number | null; exceeds_noise_threshold?: boolean; data_gap?: boolean; ambiguous?: boolean }
...
function delta(value: number | null) { return value == null ? '—' : `${value > 0 ? '+' : ''}${value.toFixed(1)} pp` }
